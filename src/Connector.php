...
class Connector {
	...
	public const BASE_USER_URL = 'https://open.tiktokapis.com/v2/user/info/?open_id=%s&access_token=%s';
	public const BASE_VIDEOS_URL = 'https://open.tiktokapis.com/v2/video/list/';
